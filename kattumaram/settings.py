"""
Django settings for kattumaram project.
...
SECRET_KEY = "django-insecure-7x(aol+17jlyd7@py^(*@jqvm&8b+nxpt(11qmyt0(o!cy94&@"
...
WSGI_APPLICATION = "kattumaram.wsgi.application"
